...
To understand why we believe it's important to account for survey design when carrying out CV, please see our journal paper submitted to the *Stat* special issue from the SDSS 2021 conference [currently under review]. (A copy can be found in the `data-raw` folder of our GitHub repository as [`Stat_SDSS_submission.pdf`](https://github.com/ColbyStatSvyRsch/surveyCV/blob/master/data-raw/Stat_SDSS_submission.pdf).)  
