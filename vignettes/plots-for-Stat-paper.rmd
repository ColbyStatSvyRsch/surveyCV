...
Based on the sims from `data-raw/plot_generation.R` -- but instead of having similar functions repeatedly defined separately as in that file, use our functions such as `cv.svy()` directly from the package.
